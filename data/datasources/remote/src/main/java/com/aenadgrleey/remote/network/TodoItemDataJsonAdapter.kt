        ...
        if (json != null) {
            ...
            jsonObject.get("importance").asString.let {
                todoItemData.importance = when (it) {
                    "low" -> com.aenadgrleey.data.utils.Importance.Low
                    "important" -> com.aenadgrleey.data.utils.Importance.High
                    else -> com.aenadgrleey.data.utils.Importance.Common
                }
            }
        }
        return todoItemData
    ...
    override fun serialize(todoItemData: TodoItemData?, typeOfSrc: Type?, context: JsonSerializationContext?): JsonElement {
        ...
        if (todoItemData != null) {
            ...
            when (todoItemData.importance) {
                com.aenadgrleey.data.utils.Importance.Low -> "low"
                com.aenadgrleey.data.utils.Importance.High -> "important"
                else -> "basic"
